...
//         Step 2:
// If user clicked ‘Ok’ – start a game: randomly (use Math.random()) choose an integer number in range [0; 5] (including 0 and 5) 
//and ask user to enter a number of pocket on which the ball could land (use prompt()).
// User has 3 attempts to guess a number.
// If user guessed the number on which ball landed, on 1-st attempt prize is 100$ (maximum prize for current numbers range), 
//2-nd attempt – 50$, 3-rd attempt – 25$. 
// If user did not guess a number show the message ‘Thank you for your participation. Your prize is: … $’ (Use alert) and ask 
//if he wants to play again (use confirm).
//          Step 3:
// If user did guess - Show the message ‘Congratulation, you won!   Your prize is: … $. Do you want to continue?’.
// If user does not want to continue – show the message ‘Thank you for your participation. Your prize is: … $’ (Use alert) and 
//ask if he wants to play again (use confirm).
// If user does want to continue, make number range bigger at 5 as the previous one (for example [0; 5] -> [0; 10]), 
